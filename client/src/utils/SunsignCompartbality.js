  ...
  switch (My_zdc) {
    case 'aries': {
      if (Partner_zdc === 'gemini' || Partner_zdc === 'sagittarious' || Partner_zdc === 'leo') {
        setResult(
          'The compatibility between you two is remarkable, making every interaction between you both feel like a seamless blend of harmony and understanding'
        );
      } else {
        setResult(
          "There might be some room for improvement in your relationship. Taking time to communicate openly, understand each other's perspectives, and find common ground could be beneficial.You both have the capability to overcome any challenges, just trust in yourselves and your bond."
        );
      }
      break;
    }
    ...
    case 'libra': {
      if (
        Partner_zdc === 'sagittarious' ||
        Partner_zdc === 'gemini' ||
        Partner_zdc === 'aquarius'
      ) {
        setResult(
          'The compatibility between you two is remarkable, making every interaction between you both feel like a seamless blend of harmony and understanding'
        );
    ...
    default:
      System.out.println(
        'Enter a valid zodiac sign. Your determination will guide you through any obstacles'
      );
  }
}
