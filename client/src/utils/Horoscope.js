export default async function Horoscope(
  ...
  switch (rashi) {
    case 'aries':
      setCareer(
        'Opportunities for advancement may arise, particularly in the second half of the year.'
      );
      setBusiness(
        'Consider implementing changes for increased profitability, especially in April, September, and October.'
      );
      setEducation(
        'Focus on studies may fluctuate, with challenges in April, August, and November.'
      );
      setRelationships(
        'Aries individuals may experience heightened romantic opportunities, especially in June to July and November to December.'
      );
    ...
    case 'taurus':
      ...
      setBusiness(
        'Consistency and steady growth are key, with potential for financial gains in April, September, and October.'
      );
      setEducation(
        'Taurus students may find steady progress, though challenges may arise in April, August, and November.'
      );
    ...
    case 'gemini':
      ...
      setBusiness(
        'Adaptability and innovation are crucial for success, particularly in April, September, and October.'
      );
      setEducation(
        'Gemini students may excel in communication-related subjects but may face distractions in April, August, and November.'
      );
      setRelationships(
        'Social connections may flourish, with peak periods in June to July and November to December.'
      );
    ...
    case 'cancer':
      ...
      setBusiness(
        'Focus on nurturing existing ventures, with potential for financial growth in April, September, and October.'
      );
      setEducation(
        'Cancer students may find comfort in familiar subjects but should beware of distractions in April, August, and November.'
      );
    ...
    case 'leo':
      ...
      setBusiness(
        'Bold decisions may lead to increased profitability, especially in April, September, and October.'
      );
      setEducation(
        'Leos may excel in creative pursuits but should beware of overconfidence in April, August, and November.'
      );
    ...
    case 'virgo':
      ...
      setBusiness(
        'Focus on efficiency and organization, with potential for financial gains in April, September, and October.'
      );
      setEducation(
        'Virgo students may excel in analytical subjects but should guard against perfectionism in April, August, and November.'
      );
    ...
    case 'libra':
      ...
      setBusiness(
        'Focus on maintaining balance and harmony in business partnerships, with potential for financial growth in April, September, and October.'
      );
      setEducation(
        'Libra students may excel in subjects requiring teamwork but should beware of indecision in April, August, and November.'
      );
    ...
    case 'scorpio':
      setCareer(
        'Opportunities for transformation and regeneration may lead to significant career shifts.'
      );
      setBusiness(
        'Embrace change and transformation in business ventures, with potential for financial gains in April, September, and October.'
      );
      setEducation(
        'Scorpio students may excel in intense and investigative subjects but should beware of secrecy in April, August, and November.'
      );
    ...
    case 'sagittarius':
      ...
      setBusiness(
        'Embrace new horizons and take calculated risks in business endeavors, with potential for financial growth in April, September, and October.'
      );
      setEducation(
        'Sagittarius students may excel in subjects related to exploration but should beware of restlessness in April, August, and November.'
      );
    ...
    case 'capricorn':
      ...
      setBusiness(
        'Focus on long-term goals and practical strategies, with potential for financial gains in April, September, and October.'
      );
      setEducation(
        'Capricorn students may excel in structured subjects but should beware of rigidity in April, August, and November.'
      );
    ...
    case 'aquarius':
      setCareer(
        'Hard work may lead to opportunities for promotion, with potential for job switching between August and October.'
      );
      setBusiness(
        'Consider making changes for increased profitability, especially in April, September, and October.'
      );
      setEducation('Focus may fluctuate, with challenges in April, August, and November.');
      setRelationships(
        'Romantic opportunities may abound, particularly in June to July and November to December.'
      );
    ...
    case 'pisces':
      ...
      setBusiness(
        'Trust your instincts and intuition in business matters, with potential for financial growth in April, September, and October.'
      );
      setEducation(
        'Pisces students may excel in imaginative subjects but should beware of escapism in April, August, and November.'
      );
      setRelationships(
        'Compassion and empathy may characterize relationships throughout the year.'
      );
