...
function SunsignHarmonyPage() {
  ...
  const SunsignHarmonyHandler = (event) => {
    ...
    if (
      document.getElementById('your_name').value.toLowerCase() !== '' &&
      document.getElementById('partners_name').value.toLowerCase() !== ''
    ) {
      setLoading(true);
      setTimeout(() => {
        setLoading(false);
              ...
              <form className='flex flex-col my-2 font-["Roboto Condensed"] w-[100%]'>
                <div>
                  <label
                    name="your_name"
                    htmlFor="your_name"
                    className="text-xl laptop:font-2xl tablet:text-2xl mobile:text-sm font-semibold"
                  >
                  ...
                  <input
                    className="name mobile:p-1 laptop:p-2 desktop:p-2 tablet:p-2 mobile:w-[100%] laptop:font-xl tablet:text-xl mobile:mb-2 mobile:text-sm border-2 rounded-md"
                    placeholder="Name"
                    type="text"
                    id="your_name"
                  />
                  <label
                    htmlFor="your_sunsign"
                  ...
                  <label
                    ...
                    className="text-xl laptop:font-2xl tablet:text-2xl mobile:text-sm font-semibold"
                  >
                    Partner's Name: <span className="text-red-700">*</span>
                  </label>{' '}
                  <br />
                  {partnerNameError ? (
                    <span className="text-xs leading-tight text-red-600">
                  ...
                  />
                  <label
                    htmlFor="partners_sunsign"
                    className="block mb-2 text-sm font-medium text-gray-900"
                  >
                    Choose your Partner's Sunsign:
                  </label>
                  <select
                    id="partners_sunsign"
                ...
                <div className="flex mobile:flex-col mobile:justify-center mobile:text-center mt-5 font-extrabold mobile:text-2xl">
                  <button
                    type="submit"
                    className="text-white w-fit bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                    onClick={SunsignHarmonyHandler}
                  >
                    Find Out
                  </button>
                </div>
